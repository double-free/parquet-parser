...
include(GoogleTest) function(yy_test) cmake_parse_arguments(YY_TEST
                                                            ""
                                                            "NAME"
                                                            "SRCS;DEPS" ${ARGN})
    ...
    set(_NAME "yy_test_${YY_TEST_NAME}")
        ...
        add_executable($ {
          _NAME
            ...
            target_link_libraries(${_NAME} PUBLIC ${YY_TEST_DEPS})
#Add all test executable to the unittest target folder.
                set_property(TARGET ${_NAME} PROPERTY FOLDER ${
                    CMAKE_CURRENT_BINARY_DIR})

                    gtest_discover_tests(${_NAME}) endfunction()
                        ...
                        function(default_yy_test)
                            cmake_parse_arguments(YY_TEST ""
                                ...
                                aux_source_directory(${
                                    YY_TEST_DIR_NAME} TEST_SRCS) yy_test(NAME ${
                                    YY_TEST_DIR_NAME} SRCS ${TEST_SRCS} ${
                                    YY_TEST_EXTRA_SRCS} DEPS gtest gtest_main ${
                                    PROJECT_NAME}) endfunction()
